...
前一小节我们介绍了Neo4j的查询处理，主要包括查询解析、查询优化和查询执行三个步骤。
...
例3.7-4 的查询语句中包含对于固定关系和节点标签的查询匹配，这是一个典型的子图同构查询，即在图3.21中查询满足图3.22图模式的子图。朴素的子图查询方法是通过暴力搜索，枚举并对比所有可能的匹配来得到目标子图，但是在查询优化的情况下Neo4j会选择代价更小的子图匹配算法，其中最经典的回溯搜索Ullmann算法描述如下：
