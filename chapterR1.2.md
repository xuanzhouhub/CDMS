...
关系代数是一种基于关系模型的查询语言，它用关系的运算来表达用户的访问需求，属于声明式程序语言。关系代数表达式既易于计算机识别和处理又能充分地表达用户的查询逻辑，是关系数据库查询语言的理论基础。本小节将详细介绍关系代数的相关内容。
...
[**上一页<<**](chapterR1.2.md) | [**>>下一页**](chapterR1.3.md)
