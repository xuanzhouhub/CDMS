...
从本节开始，我们进入关系型数据库的世界。凡是将关系模型作为数据模型的数据管理系统，我们统称为关系型数据库系统。

## 关系结构

关系模型是将数据组织成一个个关系，关系表示现实世界中的各类实体以及实体之间的联系。通常，关系可以形象地理解为一张二维表，它建立在集合论的基础之上。图R1.1中展示了学生-课程数据库的关系模型和数据实例，其中包含学生Student、课程Course和选课SC三个关系。每个关系的逻辑结构是一张二维表，它由表头和表内记录组成。

<center>
	<img src="fig/chR1.1-RelationModel.jpg" width="99%" alt="Relational Model" />
	<br>
	<div display: inline-block; padding : 2px>
		图 R1.1 学生-课程数据库的关系模型和数据实例
	</div>
</center>
...
任何一种运算都是将运算符作用于一定的运算对象上，然后得到运算结果。运算对象、运算符和运算结果是运算的三大要素。关系代数的运算对象是关系，运算结果也是关系。关系代数的运算符包括四类：集合运算符、专门的关系运算符、比较运算符和逻辑运算符，如图R1.2所示。
